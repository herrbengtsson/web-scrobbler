...
var BaseConnector = window.BaseConnector || function () {
		...
		/**
		 * Default implementation of cleaning artist and track information from garbage.
		 * This method is called from {@link BaseConnector#getArtistTrack}.
		 *
		 * Override this method for custom behaviour
		 *
		 * @returns {{artist, track}}
		 */
		this.cleanArtistTrack = function (artist, track) {
			// Do some cleanup
